...
namespace PostGrad
{
    public partial class ThesisPayment : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand pay = new SqlCommand("ViewThesisPayments", conn);
            ...
            while (rdr.Read())
            {
                ...
                Decimal fund = rdr.GetDecimal(rdr.GetOrdinal("Fund"));
        ...
        {
            Response.Redirect("Thesisinstallments.aspx");
